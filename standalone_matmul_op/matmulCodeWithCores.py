...
def main():
    # Usage: python matmul_wh_lofi.py M K N [num_cores]
    if len(sys.argv) not in (4, 5):
        print("Usage: python matmul_wh_lofi.py M K N [num_cores]")
        sys.exit(1)
    ...
    try:
        ...
        for i in range(10):
            print(
                f"Run {i+1}/10: BFLOAT8_B LoFi matmul on {core_grid.x * core_grid.y} cores..."
            )
